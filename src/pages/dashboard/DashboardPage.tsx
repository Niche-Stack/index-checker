    ...
    const fetchDashboardData = async () => {
      try {
        ...
        if (sitesData.length > 0) {
          ...
          setActionsThisMonth(historyData.filter(h => 
            h.timestamp.toDate() >= firstDayOfMonth
          ).length);
        }
      } catch (err) {
        ...
        <div className="space-y-8">
          ...
          <div className="card">
            ...
            <div className="p-6 space-y-3">
              <button className="w-full py-3 bg-blue-50 hover:bg-blue-100 text-blue-800 font-medium rounded-lg flex items-center justify-center transition-colors">
                <Search className="w-4 h-4 mr-2" />
                Check All Pages
              </button>
              <button className="w-full py-3 bg-green-50 hover:bg-green-100 text-green-800 font-medium rounded-lg flex items-center justify-center transition-colors">
